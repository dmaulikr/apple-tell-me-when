...
For information about our sensors, have a look at our [Making Sense of Sensors](https://developer.relayr.io/documents/WunderBar/Sensors) page.
...
To clone the project and all its sub-modules use:


	git clone --recursive https://github.com/relayr/apple-tell-me-when.git


Optionally, if you already have the project cloned, use:
