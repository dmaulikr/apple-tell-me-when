 ...
 */
+ (void)registerRule:(TMWRule*)rule
 ...
 *  @param completion Block indicating the result of the server query.
 */
+ (void)requestRulesForUserID:(NSString*)userID
                   completion:(void (^)(NSError* error, NSArray* rules))completion;
 ...
 *  @param completion Block indicating the result of the server query.
 */
+ (void)requestNotificationsForRuleID:(NSString*)ruleID
                           completion:(void (^)(NSError* error, NSArray* notifications))completion;
 ...
 *  @param completion Block indicating the result of the server query.
 */
+ (void)requestNotificationsForUserID:(NSString *)userID
                           completion:(void (^)(NSError *error, NSArray *notifications))completion;
